...
public class Misc {
	 ...
	 * @throws Exception
	 */
	public static boolean writeToOutput(Args options, Set<String> constraints) throws Exception {
	...
	/**
	 * Converts the Word to type List and then calls the overloaded function again.
	 * 
