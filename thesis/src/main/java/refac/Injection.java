...
public class Injection {
     ...
     * {@link StateEquivalence#calculateEquivalentStates(FastDFA, Map)} method
     * to be {@literal Map<Integer, Integer>} since we only have one element
     * (the product) in the map we receive.
     * 
     * @param specStateMap
     *            the
